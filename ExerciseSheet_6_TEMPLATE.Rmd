...
a)  Briefly describe in one - two sentences what your R package does and
    ...
    My R Package is a fun package aimed at students going on an exchange by providing them with the possibility to create interactive maps of the places they will be going to. I chose to do this, since I am currently on exchange myself (in Cape Town, South Africa) and I thought this might be useful to me and my fellow international students here.
...
e.g. `https://github.com/Loirinho1905/exercise-6`
...
``` r
remotes::install_github("Loirinho1905/exercise-6")
```
...
```{r}
semabroadmap("Budapest", "amenity", "ice_cream")
```
